...
import framework.LruBitmapCache;
...
public class ApplicationClass extends MultiDexApplication {
    ...
    public RequestQueue getRequestQueue() {
        if (mRequestQueue == null) {
            ...
            //mRequestQueue = Volley.newRequestQueue(com.kredivation.aakhale.ApplicationHelper.application().getContext(), new HurlStack(null, ClientSSLSocketFactory.getSocketFactory()));
        }
